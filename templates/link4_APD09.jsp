...
<body>
    <div class="container mt-3">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title">서버(OS/DB) 패스워드</h5>
                <p class="card-text">서버(OS/DB)의 패스워드 설정은 보안규칙에 따라 적절히 설정합니다.</p>
            </div>
            <img src="{{ url_for('static', filename='img/APD09.jpg')}}" class="card-img" alt="Access Program & Data">
        </div>
