...
<body>
    <div class="container mt-3">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title">서버(OS/DB) 접근권한 승인</h5>
                <p class="card-text">서버(OS/DB)에 접근권한이 필요한 경우 적절한 승인권자의 승인을 득합니다.</p>
            </div>
            <img src="{{ url_for('static', filename='img/APD08.jpg')}}" class="card-img" alt="Access Program & Data">
        </div>
