...
<body>
    <div class="container mt-3">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title">Application 권한 Monitoring</h5>
                <p class="card-text">사용자의 Application 권한은 정기적으로 적절성을 모니터링합니다.</p>
            </div>
            <img src="{{ url_for('static', filename='img/APD05.jpg')}}" class="card-img" alt="Access Program & Data">
        </div>
