        ...
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-card border-secondary h-100">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="text-center mt-auto">
                                <a href="/link11" class="feature-link" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-html="true" title="<div>• 투자/인력/인증/활동 현황 관리<br>• KISA 제출용 공시자료 생성</div>">자세히
                                    보기</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 mt-3 justify-content-center">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature-card">
                            <img src="{{ url_for('static', filename='img/interview.jpg')}}" class="feature-img"
                                alt="Interview">
                            <div class="card-body p-4">
                                <h5 class="feature-title text-center">인터뷰/설계평가</h5>
                                <p class="feature-description">AI와의 대화형 인터뷰를 통해 RCM을 분석하고 통제 설계를 평가합니다.</p>
                                <div class="text-center">
                                    <a href="{{ url_for('link2.itgc_interview', reset=1) }}" class="feature-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature-card">
                            <img src="{{ url_for('static', filename='img/testing.jpg')}}" class="feature-img"
                                alt="Operation Test">
                            <div class="card-body p-4">
                                <h5 class="feature-title text-center">운영평가 가이드</h5>
                                <p class="feature-description">내부통제의 운영 효과성을 평가하고 실제 운용 상태를 점검합니다.</p>
                                <div class="text-center">
                                    <a href="/link3" class="feature-link" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-html="true"
                                        title="<div>• 내부통제의 운영 효과성 평가<br>• 통제 활동의 실제 수행 상태 점검<br>• 운영상 결함 및 예외사항 식별<br>• 개선 방안 및 권고사항 제시</div>">자세히
                                        보기</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature-card border-success h-100">
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <div class="text-center mt-auto">
                                    <a href="/link10" class="feature-link" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-html="true"
                                        title="<div>• KOSPI 종목 데이터 자동 수집<br>• PBR, PER, ROE 등 투자지표 분석<br>• 업종별 평균 비교<br>• 엑셀 리포트 자동 생성</div>">자세히
                                        보기</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="feature-card h-100">
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <div class="text-center mt-auto">
                                    <a href="/link4" class="feature-link" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-html="true"
                                        title="<div>• ITGC(IT일반통제) 교육 영상<br>• 내부통제 기본 개념 및 실무 가이드<br>• 통제 설계 및 평가 방법론<br>• 실무 사례 및 베스트 프랙티스</div>">자세히
                                        보기</a>
                                </div>
                            </div>
                        </div>
