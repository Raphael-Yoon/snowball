...
<body>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            {% endif %}
                            <button id="completeEvaluationBtn" class="btn btn-sm btn-success" onclick="completeEvaluation()" style="display: none; height: 70%; padding: 0.2rem 0.5rem; width: auto;" title="설계평가를 완료 처리합니다" data-bs-toggle="tooltip">
                            ...
                            <button id="downloadBtn" class="btn btn-sm btn-outline-primary" onclick="downloadDesignEvaluation()" style="display: none; height: 70%; padding: 0.2rem 0.5rem;" title="설계평가 결과를 Excel로 다운로드합니다" data-bs-toggle="tooltip">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped align-middle" id="controlsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr id="control-row-{{ loop.index }}" {% if evaluation_type == 'ITGC' and not mapping_info %}class="table-warning"{% endif %}>
    ...
    <script>
        ...
        function downloadDesignEvaluation() {
            ...
            // 다운로드 URL 생성
            const downloadUrl = `/design-evaluation/download?rcm_id=${rcmId}&evaluation_session=${evaluationSession}`;
