        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><img src="{{ url_for('static', filename='img/tlc.jpg') }}" alt="TLC" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px; margin-right: 12px;">TLC 운영평가</h1>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">접근 가능한 TLC RCM이 없습니다.</p>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {% if tlc_rcms %}
                        {% set has_operation_sessions = tlc_rcms|selectattr('design_evaluation_completed')|list|length > 0 %}
