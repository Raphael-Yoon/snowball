        ...
        function enableStepByStep(type) {
            // 각 항목별 step 데이터 정의
                ...
                APD02: [
                    ...
                    {img: "/static/img/APD02_step3.jpg", title: "Step 3: 권한 회수 여부 점검", desc: "1. 부서이동일 이후 기존 권한의 회수 여부를 확인합니다.<br>2. 모든 사용자가 보유하고 있는 기본권한 등은 회수회지 않아도 무방합니다.<br>3. 회수되지 않은 권한이 있다면 즉시 조치합니다."}
                ],
                APD03: [
                ...
                APD04: [
                    ...
                    {img: "/static/img/APD04_step2.jpg", title: "Step 2: 샘플 선정 및 승인 여부 확인", desc: "1. 통제 주기에 따라 샘플 수를 선정합니다.<br>2. 선정된 샘플에 대해 적절한 승인(결재)이 이루어졌는지 확인합니다."},
                ],
                APD05: [
                    {img: "/static/img/APD05_step1.jpg", title: "Step 1: 보안규정 및 정책서 확인", desc: "1. 회사의 보안규정 또는 정책서에 패스워드 관련 사항이 명시되어 있는지 확인합니다."},
                    {img: "/static/img/APD05_step2.jpg", title: "Step 2: 정책 부합 여부 점검", desc: "1. 실제 시스템의 패스워드 설정이 정책서 기준(예: 최소 길이, 복잡성 등)에 부합하는지 확인합니다.<br>2. 시스템 설정 화면을 캡쳐하여 증빙으로 확보합니다.<br>3. 별도의 규정이 없는 경우, 최소 8자리 및 문자/숫자/특수문자 조합 등 기본 복잡성 요건이 적용되어 있는지 확인합니다."},
                ],
                APD06: [
                    ...
                    {img: "/static/img/APD06_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본추출 방식(Simple Random Sampling)으로 해야 하며, 임의의 데이터를 선택하면 안됩니다.<br>3. 선정된 샘플만 운영평가 조서에 별도로 작성합니다."},
                    {img: "/static/img/APD06_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플에 대한 증빙(승인 내역)을 검토합니다.<br>2. 데이터 변경 일자와 승인 일자를 비교하여 사전 승인 여부를 확인합니다."},
                ],
                APD07: [
                    ...
                    {img: "/static/img/APD07_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본 추출(Simple Random Sampling) 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다.<br>3. 선정된 샘플만 운영평가 조서에 별도로 작성합니다."},
                    {img: "/static/img/APD07_step3.jpg", title: "Step 3: 권한 부여 내역 기록 점검", desc: "1. 선정된 샘플에 대한 증빙(승인 이력)을 확인합니다.<br>2. 권한 부여 일자와 승인 일자를 대사하여 사전 승인 여부를 확인합니다."},
                ],
                APD08: [
                    {img: "/static/img/APD08_step1.jpg", title: "Step 1: 보안규정 및 정책서 확인", desc: "1. 회사의 보안규정 또는 정책서에 패스워드 관련 사항이 명시되어 있는지 확인합니다."},
                    {img: "/static/img/APD08_step2.jpg", title: "Step 2: 정책 부합 여부 점검", desc: "1. 실제 시스템의 패스워드 설정이 정책서 기준(예: 최소 길이, 복잡성 등)에 부합하는지 확인합니다.<br>2. 시스템 설정 화면을 캡쳐하여 증빙으로 확보합니다.<br>3. 별도의 규정이 없는 경우, 최소 8자리 및 문자/숫자/특수문자 조합 등 기본 복잡성 요건이 적용되어 있는지 확인합니다."},
                ],
                APD09: [
                    ...
                    {img: "/static/img/APD09_step2.jpg", title: "Step 2: 부서/직무 등 검토", desc: "1. 추출된 사용자의 부서, 직무, 담당 업무 등을 검토하여 관리자 권한 보유의 적정성을 확인합니다."},
                ],
                APD10: [
                    ...
                    {img: "/static/img/APD10_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본 추출(Simple Random Sampling) 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다.<br>3. 선정된 샘플만 운영평가 조서에 별도로 작성합니다."},
                    {img: "/static/img/APD10_step3.jpg", title: "Step 3: 권한 부여 내역 기록 점검", desc: "1. 선정된 샘플에 대한 증빙(승인 이력)을 확인합니다.<br>2. 권한 부여 일자와 승인 일자를 대사하여 사전 승인 여부를 확인합니다."}
                ],
                APD11: [
                    {img: "/static/img/APD11_step1.jpg", title: "Step 1: 보안규정 및 정책서 확인", desc: "1. 회사의 보안규정 또는 정책서에 OS 패스워드 관련 사항이 명시되어 있는지 확인합니다."},
                    {img: "/static/img/APD11_step2.jpg", title: "Step 2: 정책 부합 여부 점검", desc: "1. 실제 시스템의 OS 패스워드 설정이 정책서 기준(예: 최소 길이, 복잡성 등)에 부합하는지 확인합니다.<br>2. 시스템 설정 화면을 캡쳐하여 증빙으로 확보합니다.<br>3. 별도의 규정이 없는 경우, 최소 8자리 및 문자/숫자/특수문자 조합 등 기본 복잡성 요건이 적용되어 있는지 확인합니다."},
                ],
                APD12: [
                    ...
                    {img: "/static/img/APD12_step2.jpg", title: "Step 2: 부서/직무 등 검토", desc: "1. 추출된 사용자의 부서, 직무, 담당 업무 등을 검토하여 관리자 권한 보유의 적정성을 확인합니다."},
                ],
                PC01: [
                    ...
                    {img: "/static/img/PC01_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플에 대한 증빙(변경 요청에 대한 승인, 사용자 테스트 유무, 이관 요청에 대한 승인)을 검토합니다.<br>2. 프로그램 이관 일자와 각 증빙 일자를 비교하여 사전 승인 여부를 확인합니다.<br>3. 관련 증빙을 운영평가 조서에 첨부합니다.<br>* 프로그램 변경 승인, 프로그램 변경 사용자 테스트, 프로그램 이관 승인은 별개의 통제이나 테스트는 함께 진행할 수 있습니다."}
                ],
                PC04: [
                    ...
                    {img: "/static/img/PC04_step2.jpg", title: "Step 2: 부서/직무 등 검토", desc: "1. 추출된 사용자의 부서, 직무, 담당 업무 등을 검토하여 이관담당자 권한 보유의 적정성을 확인합니다."},
                ],
                PC05: [
                    {img: "/static/img/PC05_step1.jpg", title: "Step 1: 개발/운영 환경 분리 현황 확인", desc: "1. 시스템이 운영환경과 별도의 개발환경을 보유하고 있는지 확인합니다."},
                    {img: "/static/img/PC05_step2.jpg", title: "Step 2: 증빙 자료 확보", desc: "1. 서버 구성도, IP 목록 등으로 개발환경과 운영환경이 분리되어 있는지 증빙 자료를 확보합니다."},
                ],
                PC06: [
                    ...
                    {img: "/static/img/PC06_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플을 선정합니다.<br>2. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>3. 샘플 선정은 무작위 표본추출 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다."},
                    {img: "/static/img/PC06_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플 각각에 대해 사전 승인이 이루어졌는지 확인합니다."},
                ],
                PC07: [
                    ...
                    {img: "/static/img/PC07_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본추출 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다."},
                    {img: "/static/img/PC07_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플 각각에 대해 사전 승인이 이루어졌는지 확인합니다."},
                ],
                PC08: [
                    {img: "/static/img/PC08_step1.jpg", title: "Step 1: 모집단 확인", desc: "1. 해당 통제의 모집단을 시스템에서 추출합니다.<br>2. 추출 시점의 데이터 건수와 캡쳐 화면을 확보하여 완전성을 확인합니다.<br>- 해당 통제는 SAP ERP, Oracle ERP 등 Package 형태의 ERP 시스템을 운영하는 경우에만 적용됩니다."},
                    {img: "/static/img/PC08_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본추출 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다."},
                    {img: "/static/img/PC08_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플 각각에 대해 사전 승인이 이루어졌는지 확인합니다.<br>2. 변경 내역이 적절하게 기록되어 있는지 확인합니다."},
                ],
                CO01: [
                    ...
                    {img: "/static/img/CO01_step2.jpg", title: "Step 2: 샘플 선정", desc: "1. 모집단 수에 따라 샘플 수를 결정합니다. (예: 모집단이 10개인 경우 Quarterly와 Monthly 사이이므로 2개, 13개인 경우 Monthly와 Weekly 사이이므로 5개 선정 등)<br>2. 샘플 선정은 무작위 표본추출 방식으로 해야 하며, 임의의 데이터를 선택하면 안됩니다."},
                    {img: "/static/img/CO01_step3.jpg", title: "Step 3: 증빙 확인", desc: "1. 선정된 샘플 각각에 대해 사전 승인이 이루어졌는지 확인합니다."},
                ],
                CO02: [
                    ...
                    {img: "/static/img/CO02_step2.jpg", title: "Step 2: 부서/직무 등 검토", desc: "1. 추출된 사용자의 부서, 직무, 담당 업무 등을 검토하여 배치잡 등록 권한 보유의 적정성을 확인합니다."},
                ],
                CO03: [
                ...
                CO04: [
                    ...
                    {img: "/static/img/CO04_step2.jpg", title: "Step 2: 샘플 선정 및 승인 ㅇ부 확인", desc: "1. 통제 주기에 따라 샘플 수를 선정합니다.<br>2. 선정된 샘플에 대해 적절한 승인(결재)이 이루어졌는지 확인합니다."},
                ],
                CO05: [
