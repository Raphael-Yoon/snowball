...
<body>
    <div class="container">
        <div class="login-wrapper">
            ...
            {% if not is_production and (remote_addr == '127.0.0.1' or request.host.startswith('127.0.0.1') or request.host.startswith('localhost') or request.host.startswith('snowball.pythonanywhere.com')) %}
