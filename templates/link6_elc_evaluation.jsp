...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><img src="{{ url_for('static', filename='img/elc.jpg') }}" alt="ELC" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px; margin-right: 12px;">ELC 평가</h1>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        {% if elc_rcms %}
                        {% set has_design_sessions = elc_rcms|selectattr('has_design_sessions')|list|length > 0 %}
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        {% if elc_rcms %}
                        {% set has_operation_sessions = elc_rcms|selectattr('has_operation_sessions')|list|length > 0 %}
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="opcollapse{{ rcm.rcm_id }}" class="accordion-collapse collapse" data-bs-parent="#operationEvaluationAccordion">
                                    <div class="accordion-body">
                                        ...
                                        {% if rcm.completed_design_sessions %}
                                        <hr class="my-3">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-sm"
                                                                onclick="showOperationStartModal({{ rcm.rcm_id }}, '{{ session.evaluation_session }}', 0, {{ session.eligible_control_count }})">
                            ...
                            <a href="#" class="list-group-item list-group-item-action" onclick="selectRcmForDesignEvaluation({{ rcm.rcm_id }}, '{{ rcm.rcm_name }}'); return false;">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">Control Category: ELC</small>
                                    </div>
    ...
    <script>
        ...
        function startDesignEvaluationWithName() {
            ...
            form.method = 'POST';
            form.action = '/elc/design-evaluation/start';
