...
CONTROL_SPECIFIC_CRITERIA = {
    ...
    'APD04': [
        ...
        "Application 관리자 권한 보유자의 부서, 직급, 직무가 구체적으로 기술되어 있는지 확인",
        "Application 관리자 권한 보유자가 적정한 인원인지 판단"
    ],
    'APD05': [
    ...
    'PC04': [
        ...
        "이관권한 보유자의 부서, 직급, 직무가 구체적으로 기술되어 있는지 확인",
        "이관권한 보유자가 적정한 인원인지 판단"
    ],
    'PC05': [
