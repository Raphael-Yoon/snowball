...
s_questions = [
    ...
    {"index": 16, "text": "패스워드 설정사항을 기술해 주세요(최소자리, 복잡성, 변경주기 등)."},
    ...
    {"index": 22, "text": "DB 패스워드 설정사항을 기술해 주세요(최소자리, 복잡성, 변경주기 등)."},
    ...
    {"index": 26, "text": "OS 패스워드 설정사항을 기술해 주세요(최소자리, 복잡성, 변경주기 등)."},
