...
class Link3E2ETest(PlaywrightTestBase):
    def __init__(self, base_url="http://localhost:5001", **kwargs):
        super().__init__(base_url=base_url, **kwargs)
        self.category = "Link3: 운영평가 가이드"
        self.checklist_source = project_root / "test" / "e2e_checklist_link3.md"
        self.checklist_result = project_root / "test" / "e2e_checklist_link3_result.md"

    def test_link3_access(self, result: E2ETestResult):
        """1. 페이지 접근 확인"""
    ...
    def test_link3_initial_ui(self, result: E2ETestResult):
        """1. 초기 진입 UI 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_sidebar_categories(self, result: E2ETestResult):
        """1. 사이드바 카테고리 구성 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_download_button_initial(self, result: E2ETestResult):
        """1. 초기 다운로드 버튼 상태 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_sidebar_toggle(self, result: E2ETestResult):
        """2. 사이드바 펼치기/접기 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_content_loading(self, result: E2ETestResult):
        """2. 항목 클릭 시 컨텐츠 로드 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_step_navigation(self, result: E2ETestResult):
        """2. 다음/이전 단계 이동 확인"""
        self.navigate_to("/link3")
        self._expand_category("Access Program & Data")
        self.page.locator("text=Application 권한부여 승인").click()
    ...
    def test_link3_download_button_active(self, result: E2ETestResult):
    ...
    def test_link3_download_link_correct(self, result: E2ETestResult):
        """2. 다운로드 링크 주소 확인"""
        self.navigate_to("/link3")
    ...
    def test_link3_activity_log(self, result: E2ETestResult):
...
def run_tests():
    test_runner = Link3E2ETest(headless=False, slow_mo=500)
    test_runner.setup()
    try:
        test_runner.run_category("Link3 E2E Tests", [
