"""
Link9: 서비스 문의 (Contact Us) E2E 테스트 코드
"""
...
class Link9E2ETest(PlaywrightTestBase):
    def __init__(self, base_url="http://localhost:5001", **kwargs):
        super().__init__(base_url=base_url, **kwargs)
        self.category = "Link9: 서비스 문의"
        self.checklist_source = project_root / "test" / "e2e_checklist_link9.md"
        self.checklist_result = project_root / "test" / "e2e_checklist_link9_result.md"

    def test_link9_access(self, result: E2ETestResult):
        """1. 페이지 접근 확인"""
    ...
    def test_link9_ui_guest(self, result: E2ETestResult):
        """1. 게스트 UI 상태 확인"""
        self._do_logout()
        self.navigate_to("/contact")
    ...
    def test_link9_ui_logged_in(self, result: E2ETestResult):
        """1. 로그인 상태 UI 확인"""
    ...
    def test_link9_form_validation(self, result: E2ETestResult):
        """2. 폼 유효성 검사 확인"""
        self._do_logout()
        self.navigate_to("/contact")
    ...
    def test_link9_send_success(self, result: E2ETestResult):
        """2. 문의 전송 성공 확인"""
        self._do_logout()
        self.navigate_to("/contact")
        ...
        self.page.fill("#message", "E2E Test Message: Link9 Contact Us Test")
    ...
    def test_link9_service_inquiry(self, result: E2ETestResult):
        """3. 로그인 페이지 서비스 문의 확인"""
        self._do_logout()
...
def run_tests():
    test_runner = Link9E2ETest(headless=False, slow_mo=500)
    test_runner.setup()
    try:
        test_runner.run_category("Link9 E2E Tests", [
