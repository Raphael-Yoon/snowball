...
class Link10E2ETest(PlaywrightTestBase):
    def __init__(self, base_url="http://localhost:5001", **kwargs):
        super().__init__(base_url=base_url, **kwargs)
        self.category = "Link10: AI 분석 결과"
        self.checklist_source = project_root / "test" / "e2e_checklist_link10.md"
        self.checklist_result = project_root / "test" / "e2e_checklist_link10_result.md"

    def test_link10_access(self, result: E2ETestResult):
        """1. 페이지 접근 확인"""
    ...
    def test_link10_loading_state(self, result: E2ETestResult):
        """1. 로딩 스피너 확인"""
        self.navigate_to("/link10")
    ...
    def test_link10_empty_state_or_list(self, result: E2ETestResult):
        """1. 결과 목록 표시 확인"""
        self.navigate_to("/link10")
        # 데이터가 로드될 때까지 충분히 대기
    ...
    def test_link10_view_report(self, result: E2ETestResult):
    ...
    def test_link10_report_content(self, result: E2ETestResult):
        """2. 모달 내 리포트 내용 로드 확인"""
        self.navigate_to("/link10")
        self.page.wait_for_timeout(2000)
    ...
    def test_link10_modal_close(self, result: E2ETestResult):
        """2. 모달 닫기 확인"""
        self.navigate_to("/link10")
    ...
    def test_link10_send_report_guest(self, result: E2ETestResult):
    ...
    def test_link10_email_validation(self, result: E2ETestResult):
        """3. 이메일 유효성 검사 확인"""
        self._do_logout()
        self.navigate_to("/link10")
        self.page.wait_for_timeout(2000)
    ...
    def test_link10_logged_in_action(self, result: E2ETestResult):
        """3. 로그인 상태에서 전송 액션 확인"""
        try:
...
def run_tests():
    test_runner = Link10E2ETest(headless=False, slow_mo=500)
    test_runner.setup()
    try:
        test_runner.run_category("Link10 E2E Tests", [
