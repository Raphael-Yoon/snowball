...
def get_rcm_ai_review(control_content, control_code=None, control_name=None):
    ...
    try:
        ...
        response = client.chat.completions.create(
            model=model_name,
            messages=[
                {"role": "system", "content": "RCM 통제 설계를 평가하는 전문가입니다. 오직 제시된 '검토 기준'만을 기준으로 평가하세요. 통제 내용이 검토 기준을 충족한다면 반드시 '현재 통제 설계가 적정합니다'라고 답변하세요. 검토 기준에 명시되지 않은 추가 요구사항을 제시하지 마세요. 관대하게 평가하세요."},
